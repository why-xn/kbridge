...
type streamSender interface {
	Send(*agentpb.ControlPlaneStreamMessage) error
}
...
func (m *SessionManager) startSession(agentID string, start *agentpb.StartStream) (*Session, error) {
	...
	if err := sendLocked(conn, &agentpb.ControlPlaneStreamMessage{
		Msg: &agentpb.ControlPlaneStreamMessage_Start{Start: start},
	}); err != nil {
...
func (m *SessionManager) SendStdin(sessionID string, data []byte) error {
	...
	return sendLocked(conn, &agentpb.ControlPlaneStreamMessage{Msg: &agentpb.ControlPlaneStreamMessage_Stdin{
...
func (m *SessionManager) SendResize(sessionID string, rows, cols uint32) error {
	...
	return sendLocked(conn, &agentpb.ControlPlaneStreamMessage{Msg: &agentpb.ControlPlaneStreamMessage_Resize{
...
func (m *SessionManager) StartPortForward(agentID, pod, namespace string, ports []uint32) (*Session, error) {
	...
	err := sendLocked(conn, &agentpb.ControlPlaneStreamMessage{Msg: &agentpb.ControlPlaneStreamMessage_PfStart{
...
func (m *SessionManager) SendPfOpen(sessionID string, connID, remotePort uint32) error {
	...
	return sendLocked(conn, &agentpb.ControlPlaneStreamMessage{Msg: &agentpb.ControlPlaneStreamMessage_PfOpen{
...
func (m *SessionManager) SendPfData(sessionID string, connID uint32, data []byte) error {
	...
	return sendLocked(conn, &agentpb.ControlPlaneStreamMessage{Msg: &agentpb.ControlPlaneStreamMessage_PfData{
...
func (m *SessionManager) SendPfClose(sessionID string, connID uint32) error {
	...
	return sendLocked(conn, &agentpb.ControlPlaneStreamMessage{Msg: &agentpb.ControlPlaneStreamMessage_PfClose{
...
func (m *SessionManager) Cancel(sessionID string) {
	...
	if conn != nil {
		...
		sendLocked(conn, &agentpb.ControlPlaneStreamMessage{Msg: &agentpb.ControlPlaneStreamMessage_Cancel{ //nolint:errcheck
...
func sendLocked(conn *agentConn, msg *agentpb.ControlPlaneStreamMessage) error {
	conn.mu.Lock()
